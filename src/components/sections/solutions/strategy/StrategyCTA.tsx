...
<style>
  ...
  .str-cta-btn-accent:hover {
    background: #3a9fe0;
    transform: translateY(-2px);
    box-shadow: 0 8px 24px rgba(71,181,255,0.2);
  }

  .str-cta-btn-secondary {
    font-family: 'DM Mono', monospace;
    font-size: 12px;
    font-weight: 500;
    letter-spacing: 0.14em;
...
<section class="str-cta">
  <div class="str-cta-frame"></div>
  <div class="str-cta-inner">
    <div class="str-cta-eyebrow">Start With Strategy</div>
    <h2>Let's Define The<br><em>Foundation</em></h2>
    <p class="str-cta-text">
      Whether your programme is at inception or mid-construction — the strategy layer brings clarity, governance, and control. Let's talk about what your project needs.
    </p>
    <div class="str-cta-buttons">
      <a href="/contact/" class="str-cta-btn-accent">Schedule a Call →</a>
      <a href="/solutions/" class="str-cta-btn-secondary">All Solutions →</a>
    </div>
    <div class="str-cta-trust">
      <div class="str-cta-trust-item"><span>55+</span> Years Experience</div>
      <div class="str-cta-trust-item"><span>$50B+</span> Assets Delivered</div>
      <div class="str-cta-trust-item"><span>ISO 19650</span> Aligned</div>
      <div class="str-cta-trust-item"><span>3</span> Countries</div>
    </div>
  </div>
</section>
`;
