...
.ss-intro{max-width:1200px;margin:0 auto;padding:0 32px 64px;border-bottom:1px solid rgba(11,60,93,.08);margin-bottom:0}
.ss-intro-top{display:flex;align-items:center;gap:16px;margin-bottom:10px}
.ss-intro-dash{width:28px;height:2px;background:#47B5FF}
.ss-intro-ey{font-family:'DM Mono',monospace;font-size:13px;letter-spacing:.22em;text-transform:uppercase;color:#47B5FF;font-weight:500}
.ss-intro-h{font-family:'Inter Tight',sans-serif;font-weight:900;font-size:clamp(28px,3vw,38px);text-transform:uppercase;letter-spacing:-.02em;color:#0B3C5D;margin:0;line-height:1.15}
.ss-intro-h em{font-style:italic;color:#47B5FF}
@media(max-width:640px){.ss-intro{padding:0 20px 48px}}
